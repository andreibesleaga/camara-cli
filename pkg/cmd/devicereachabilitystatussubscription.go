...
var devicereachabilitystatusSubscriptionsCreate = requestflag.WithInnerFlags(cli.Command{
	Name:    "create",
	Usage:   "Create a device reachability status event subscription for a device",
	Suggest: true,
	Flags: []cli.Flag{
	...
	Action:          handleDevicereachabilitystatusSubscriptionsCreate,
...
var devicereachabilitystatusSubscriptionsRetrieve = cli.Command{
	Name:    "retrieve",
	...
	Action:          handleDevicereachabilitystatusSubscriptionsRetrieve,
	HideHelpCommand: true,
}

var devicereachabilitystatusSubscriptionsList = cli.Command{
	Name:    "list",
	Usage:   "Retrieve a list of device reachability status event subscription(s)",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:       "x-correlator",
	...
	Action:          handleDevicereachabilitystatusSubscriptionsList,
	HideHelpCommand: true,
}

var devicereachabilitystatusSubscriptionsDelete = cli.Command{
	Name:    "delete",
	...
	Action:          handleDevicereachabilitystatusSubscriptionsDelete,
	HideHelpCommand: true,
}

func handleDevicereachabilitystatusSubscriptionsCreate(ctx context.Context, cmd *cli.Command) error {
...
func handleDevicereachabilitystatusSubscriptionsRetrieve(ctx context.Context, cmd *cli.Command) error {
	...
	var res []byte
	options = append(options, option.WithResponseBodyInto(&res))
	_, err = client.Devicereachabilitystatus.Subscriptions.Get(
		ctx,
...
func handleDevicereachabilitystatusSubscriptionsDelete(ctx context.Context, cmd *cli.Command) error {
	...
	var res []byte
	options = append(options, option.WithResponseBodyInto(&res))
	_, err = client.Devicereachabilitystatus.Subscriptions.Delete(
		ctx,
		cmd.Value("subscription-id").(string),
		params,
		options...,
