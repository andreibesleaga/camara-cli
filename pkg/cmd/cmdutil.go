...
import (
	...
	"github.com/andreibesleaga/camara-cli/internal/jsonview"
...
func getDefaultRequestOptions(cmd *cli.Command) []option.RequestOption {
	opts := []option.RequestOption{
		option.WithHeader("User-Agent", fmt.Sprintf("Camara/CLI %s", Version)),
	...
	if cmd.IsSet("customer-insights-token") {
		opts = append(opts, option.WithCustomerInsightsToken(cmd.String("customer-insights-token")))
	}
	if cmd.IsSet("device-swap-token") {
		opts = append(opts, option.WithDeviceSwapToken(cmd.String("device-swap-token")))
	}
	if cmd.IsSet("kyc-age-verification-token") {
		opts = append(opts, option.WithKYCAgeVerificationToken(cmd.String("kyc-age-verification-token")))
	}
	if cmd.IsSet("kyc-fill-in-token") {
		opts = append(opts, option.WithKYCFillInToken(cmd.String("kyc-fill-in-token")))
	}
	if cmd.IsSet("kyc-match-token") {
		opts = append(opts, option.WithKYCMatchToken(cmd.String("kyc-match-token")))
	}
	if cmd.IsSet("tenure-token") {
		opts = append(opts, option.WithTenureToken(cmd.String("tenure-token")))
	}
	if cmd.IsSet("number-recycling-token") {
		opts = append(opts, option.WithNumberRecyclingToken(cmd.String("number-recycling-token")))
	}
	if cmd.IsSet("otp-validation-token") {
		opts = append(opts, option.WithOtpValidationToken(cmd.String("otp-validation-token")))
	}
	if cmd.IsSet("call-forwarding-signal-token") {
		opts = append(opts, option.WithCallForwardingSignalToken(cmd.String("call-forwarding-signal-token")))
	}
	if cmd.IsSet("device-location-token") {
		opts = append(opts, option.WithDeviceLocationToken(cmd.String("device-location-token")))
	}
	if cmd.IsSet("population-density-data-token") {
		opts = append(opts, option.WithPopulationDensityDataToken(cmd.String("population-density-data-token")))
	}
	if cmd.IsSet("region-device-count-token") {
		opts = append(opts, option.WithRegionDeviceCountToken(cmd.String("region-device-count-token")))
	}
	if cmd.IsSet("web-rtc-token") {
		opts = append(opts, option.WithWebRtcToken(cmd.String("web-rtc-token")))
	}
	if cmd.IsSet("connectivity-insights-token") {
		opts = append(opts, option.WithConnectivityInsightsToken(cmd.String("connectivity-insights-token")))
	}
	if cmd.IsSet("quality-on-demand-token") {
		opts = append(opts, option.WithQualityOnDemandToken(cmd.String("quality-on-demand-token")))
	}
	if cmd.IsSet("device-identifier-token") {
		opts = append(opts, option.WithDeviceIdentifierToken(cmd.String("device-identifier-token")))
	}
	if cmd.IsSet("sim-swap-token") {
		opts = append(opts, option.WithSimSwapToken(cmd.String("sim-swap-token")))
	}
	if cmd.IsSet("device-roaming-status-token") {
		opts = append(opts, option.WithDeviceRoamingStatusToken(cmd.String("device-roaming-status-token")))
	}
	if cmd.IsSet("device-reachability-status-token") {
		opts = append(opts, option.WithDeviceReachabilityStatusToken(cmd.String("device-reachability-status-token")))
	}
	if cmd.IsSet("connected-network-type-token") {
		opts = append(opts, option.WithConnectedNetworkTypeToken(cmd.String("connected-network-type-token")))
	}
	if cmd.IsSet("device-location-notifications-api-key") {
		opts = append(opts, option.WithDeviceLocationNotificationsAPIKey(cmd.String("device-location-notifications-api-key")))
	}
	if cmd.IsSet("notifications-api-key") {
		opts = append(opts, option.WithNotificationsAPIKey(cmd.String("notifications-api-key")))
	}
	if cmd.IsSet("population-density-data-notifications-api-key") {
		opts = append(opts, option.WithPopulationDensityDataNotificationsAPIKey(cmd.String("population-density-data-notifications-api-key")))
	}
	if cmd.IsSet("region-device-count-notifications-api-key") {
		opts = append(opts, option.WithRegionDeviceCountNotificationsAPIKey(cmd.String("region-device-count-notifications-api-key")))
	}
	if cmd.IsSet("connectivity-insights-notifications-api-key") {
		opts = append(opts, option.WithConnectivityInsightsNotificationsAPIKey(cmd.String("connectivity-insights-notifications-api-key")))
	}
	if cmd.IsSet("sim-swap-notifications-api-key") {
		opts = append(opts, option.WithSimSwapNotificationsAPIKey(cmd.String("sim-swap-notifications-api-key")))
	}
	if cmd.IsSet("device-roaming-status-notifications-api-key") {
		opts = append(opts, option.WithDeviceRoamingStatusNotificationsAPIKey(cmd.String("device-roaming-status-notifications-api-key")))
	}
	if cmd.IsSet("device-reachability-status-notifications-api-key") {
		opts = append(opts, option.WithDeviceReachabilityStatusNotificationsAPIKey(cmd.String("device-reachability-status-notifications-api-key")))
	}
	if cmd.IsSet("connected-network-type-notifications-api-key") {
		opts = append(opts, option.WithConnectedNetworkTypeNotificationsAPIKey(cmd.String("connected-network-type-notifications-api-key")))
	}
