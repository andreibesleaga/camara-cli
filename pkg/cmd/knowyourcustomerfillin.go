...
var knowyourcustomerfillInCreate = cli.Command{
	Name:    "create",
	Usage:   "Providing information related to a customer identity stored the account data\nbound to the customer's phone number.",
	Suggest: true,
	Flags: []cli.Flag{
	...
	Action:          handleKnowyourcustomerfillInCreate,
	HideHelpCommand: true,
}

func handleKnowyourcustomerfillInCreate(ctx context.Context, cmd *cli.Command) error {
